/**
 * Create Review - Form Enhancements & Star Rating UX
 * Fitur: Visual feedback star rating, validasi form, auto-focus, character counter
 */
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    // Initial state: update stars based on pre-selected value (from old() or edit)
    ...
    // Hover effect for stars (optional enhancement)
    starLabels.forEach(label => {
    ...
    console.log('✅ Create Review form loaded with star rating UX');
});