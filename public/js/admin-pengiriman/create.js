document.addEventListener('DOMContentLoaded', function () {
    ...
    if (form) {
        form.addEventListener('submit', function (e) {
            ...
            // Konfirmasi submit (opsional)
            // if (!confirm('Apakah data pengiriman sudah benar?')) {
            //     e.preventDefault();
            //     return false;
            // }
        });
    ...
    // ===== UX: Placeholder helper untuk alamat =====
    if (alamatInput && !alamatInput.value) {
        alamatInput.placeholder = 'Contoh: Jl. Mawar No. 12, RT 003/RW 002, Kel. Pucang Sewu';
    }

    console.log('✅ Create Pengiriman form loaded with validations');
});