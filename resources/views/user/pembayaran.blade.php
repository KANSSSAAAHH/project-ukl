...
<body>
    ...
    <main class="page">
        ...
        <section class="card">
            ...
            {{-- Payment Guide by Method --}}
            @if($pembayaran->metode === 'GoPay')
                <div class="payment-guide gopay">
                    <div class="guide-title">
                        <i class="fa-solid fa-qrcode"></i> Scan QR Code GoPay
                    </div>
                    <div class="qr-wrapper">
                        <img src="{{ asset('images/gopay.png') }}" alt="QR Code GoPay" class="qr-image">
                    </div>
                    <p class="guide-note">
            ...
            @elseif($pembayaran->metode === 'Dana')
                <div class="payment-guide dana">
                    <div class="guide-title">
                        <i class="fa-solid fa-mobile-screen"></i> Transfer via Dana
                    </div>
                    <div class="payment-number" id="paymentNumber">+62 852-3241-1498</div>
                    <button class="copy-btn" data-nomor="+628523241498">
                        <i class="fa-solid fa-copy"></i> Salin Nomor
                    </button>
                    <p class="guide-note" style="margin-top:12px;">
            ...
            @elseif($pembayaran->metode === 'OVO')
                <div class="payment-guide ovo">
                    <div class="guide-title">
                        <i class="fa-solid fa-mobile-screen"></i> Transfer via OVO
                    </div>
                    <div class="payment-number" id="paymentNumber">+62 852-3241-1498</div>
                    <button class="copy-btn" data-nomor="+628523241498">
                        <i class="fa-solid fa-copy"></i> Salin Nomor
        ...
        <section class="card">
            ...
            @else
                ...
                <form action="{{ route('pembayaran.upload', $pesanan->id_pesanan) }}" 
                      method="POST" 
                    ...
                    <div class="upload-zone">
                        ...
                        <p style="font-size:0.78rem;color:var(--text-light);margin-top:4px;">
                            JPG, PNG maks 2MB
                        </p>
                        <input type="file" 
                               name="bukti_bayar" 
                    ...
                    <button type="submit" class="btn-submit">
                        <span><i class="fa-solid fa-paper-plane"></i> Kirim Bukti Pembayaran</span>
                    </button>
                </form>
            @endif
        </section>
    ...
    {{-- Scripts --}}
    @vite('resources/js/user/pembayaran.js')
</body>
</html>