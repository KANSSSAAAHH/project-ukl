...
<head>
    ...
    {{-- Styles --}}
    @vite('resources/css/user/detail-pesanan.css')
</head>
<body>
    {{-- Navigation --}}
    <nav class="navbar">
    ...
    <main class="page">
        ...
        <section class="card">
            <h2 class="card-title">
                <i class="fa-solid fa-route"></i> Status Pesanan
            </h2>
            <div class="tracker">
        ...
        <section class="card">
            <h2 class="card-title">
                <i class="fa-solid fa-cookie"></i> Produk Dipesan
            </h2>
        ...
        <section class="card">
            ...
            <div class="info-row">
                ...
                <span class="info-value">
                    {{ $pesanan->pengiriman->kota }}, {{ $pesanan->pengiriman->kecamatan }}
                </span>
            </div>
            <div class="info-row">
        ...
        <section class="card">
            ...
            @else
                <div class="info-row">
                    ...
                    <a href="{{ route('pembayaran.index', encrypt($pesanan->id_pesanan)) }}" 
                       class="btn-upload">
    ...
    {{-- Scripts --}}
    @vite('resources/js/user/detail-pesanan.js')
</body>
</html>