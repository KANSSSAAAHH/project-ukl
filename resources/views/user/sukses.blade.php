...
<style>
:root{--crimson:#8B1A1A;--crimson-soft:#B22222;--gold:#C9923A;--gold-light:#E8B86D;--cream:#FDF6ED;--brown:#3D1C00;--text-dark:#1E0A00;--text-mid:#5C3317;--text-light:#9E7650;--white:#FFFFFF;--radius:16px;--transition:0.3s cubic-bezier(0.4,0,0.2,1);}
...
.card{background:var(--white);border-radius:24px;padding:48px 40px;text-align:center;max-width:440px;width:100%;box-shadow:0 20px 60px rgba(139,26,26,0.15);}
...
.btn-home{display:inline-flex;align-items:center;justify-content:center;gap:9px;background:linear-gradient(135deg,var(--crimson),var(--crimson-soft));color:var(--white);padding:14px 32px;border-radius:50px;font-family:inherit;font-size:0.95rem;font-weight:600;text-decoration:none;box-shadow:0 6px 24px rgba(139,26,26,0.3);transition:transform var(--transition),box-shadow var(--transition);}
.btn-home:hover{transform:translateY(-2px);box-shadow:0 10px 32px rgba(139,26,26,0.4);}
