...
<title>Tambah Pengiriman – PawonLokal</title>
...
<link rel="stylesheet" href="{{ asset('css/admin-pengiriman/create.css') }}">
</head>
<body>
<div class="wrapper">
<aside class="sidebar">
...
<div class="main">
    <div class="topbar">
        <div>
            <div class="topbar-title">Tambah Pengiriman</div>
    ...
    <div class="content">
        <div class="page-header">
            ...
            <p>Isi form berikut untuk menambah data pengiriman</p>
        </div>
        <div class="form-card">
            <form action="{{ route('admin.pengiriman.store') }}" method="POST">
                ...
                <div class="form-row">
                    <div class="form-group">
                        ...
                        <input type="text" name="nama_penerima" class="form-control" value="{{ old('nama_penerima') }}" placeholder="Nama lengkap penerima" required>
                ...
                <div class="form-group">
                    ...
                    <textarea name="alamat_lengkap" class="form-control" placeholder="Jl. contoh No. 1, RT/RW..." required>{{ old('alamat_lengkap') }}</textarea>
                ...
                <div class="form-row">
                    <div class="form-group">
                        ...
                        <input type="text" name="kota" class="form-control" value="{{ old('kota') }}" placeholder="Surabaya" required>
                        @error('kota') <div class="error-msg">{{ $message }}</div> @enderror
                    </div>
                    <div class="form-group">
                        <label>Kecamatan <span>*</span></label>
                        <input type="text" name="kecamatan" class="form-control" value="{{ old('kecamatan') }}" placeholder="Wonokromo" required>
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="kode_pos" class="form-control" value="{{ old('kode_pos') }}" placeholder="60123" required style="max-width:200px;">
...
<script src="{{ asset('js/admin-pengiriman/create.js') }}"></script>
</body>
</html>