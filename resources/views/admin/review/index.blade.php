...
.stars { color: var(--gold); font-size: 0.85rem; display: flex; gap: 2px; }
.komentar-text { max-width: 250px; overflow: hidden; text-overflow: ellipsis; white-space: nowrap; color: var(--text-mid); font-style: italic; }
...
<div class="main">
    <div class="topbar">
        <div>
            ...
            <div class="topbar-breadcrumb">Admin <i class="fa-solid fa-chevron-right" style="font-size:.55rem"></i> <span>Review</span></div>
        </div>
    </div>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <div style="font-size:0.72rem;color:var(--text-light);margin-top:2px">{{ $r->rating }}/5</div>
                            </td>
                            <td><div class="komentar-text">"{{ $r->komentar }}"</div></td>
                            <td>
