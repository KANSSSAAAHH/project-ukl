...
.bukti-img { width: 50px; height: 50px; border-radius: 8px; object-fit: cover; border: 2px solid #f0e8de; cursor: pointer; }
...
<div class="main">
    <div class="topbar">
        <div>
            ...
            <div class="topbar-breadcrumb">Admin <i class="fa-solid fa-chevron-right" style="font-size:.55rem"></i> <span>Pembayaran</span></div>
        </div>
    </div>
    <div class="content">
                ...
                <table>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                @if($p->bukti_bayar)
                                    <img class="bukti-img" src="{{ asset('storage/'.$p->bukti_bayar) }}" alt="Bukti"
                                         onerror="this.outerHTML='<span style=color:#aaa;font-size:0.75rem>Tidak ada</span>'">
                                @else
                                    <span style="color:#aaa;font-size:0.75rem">Tidak ada</span>
                                @endif
                            </td>
                            <td>
                                <div class="action-group">
                                    ...
                                    <form action="{{ route('admin.pembayaran.destroy', $p->id_pembayaran) }}" method="POST" onsubmit="return confirm('Hapus pembayaran ini?')">
                                        @csrf @method('DELETE')
                        ...
                        @empty
                        <tr><td colspan="6"><div class="empty"><i class="fa-solid fa-credit-card"></i><p>Belum ada pembayaran</p></div></td></tr>
                        @endforelse
                    </tbody>
                </table>
            </div>
