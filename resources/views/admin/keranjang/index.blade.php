...
.prod-img { width: 40px; height: 40px; border-radius: 8px; object-fit: cover; border: 2px solid #f0e8de; }
.prod-img-placeholder { width: 40px; height: 40px; border-radius: 8px; background: linear-gradient(135deg, #f5ece0, #e8d8c0); display: flex; align-items: center; justify-content: center; color: #c8a06a; }
</style>
</head>
<body>
<div class="wrapper">
...
<div class="main">
    <div class="topbar">
        <div>
            ...
            <div class="topbar-breadcrumb">Admin <i class="fa-solid fa-chevron-right" style="font-size:.55rem"></i> <span>Keranjang</span></div>
        </div>
    </div>
    <div class="content">
            ...
            <div class="table-wrap">
                <table>
                    ...
                    <tbody>
                        ...
                        @empty
                        <tr><td colspan="6"><div class="empty"><i class="fa-solid fa-basket-shopping"></i><p>Keranjang kosong</p></div></td></tr>
                        @endforelse
                    </tbody>
                </table>
            </div>
