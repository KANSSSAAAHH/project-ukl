...
<title>Tambah Keranjang – PawonLokal</title>
...
<link rel="stylesheet" href="{{ asset('css/admin-keranjang/create.css') }}">
</head>
<body>
<div class="wrapper">
<aside class="sidebar">
...
<div class="main">
    <div class="topbar">
        <div>
            <div class="topbar-title">Tambah Keranjang</div>
    ...
    <div class="content">
        <div class="page-header">
            <h1>Tambah Item Keranjang</h1>
            <p>Isi form berikut untuk menambah item ke keranjang</p>
        </div>
        <div class="form-card">
...
<script src="{{ asset('js/admin-keranjang/create.js') }}"></script>
</body>
</html>