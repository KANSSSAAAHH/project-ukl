...
<title>Tambah Detail Pesanan – PawonLokal</title>
...
<link rel="stylesheet" href="{{ asset('css/admin-detail-pesanan/create.css') }}">
</head>
<body>
<div class="wrapper">
<aside class="sidebar">
...
<div class="main">
    <div class="topbar">
        <div>
            <div class="topbar-title">Tambah Detail Pesanan</div>
    ...
    <div class="content">
        <div class="page-header">
            ...
            <p>Isi form berikut untuk menambah detail pesanan</p>
        </div>
        <div class="form-card">
            <form action="{{ route('admin.detail-pesanan.store') }}" method="POST">
                @csrf
                    ...
                    <select name="id_produk" class="form-control" required id="produkSelect">
                        ...
                        @foreach($produk as $pr)
                            <option value="{{ $pr->id_produk }}"
                                    data-harga="{{ $pr->harga }}"
                                    {{ old('id_produk') == $pr->id_produk ? 'selected' : '' }}>
                ...
                <div class="form-row">
                    <div class="form-group">
                        ...
                        <input type="number" name="jumlah_produk" id="jumlah" class="form-control"
                               value="{{ old('jumlah_produk', 1) }}" min="1" required>
                ...
                <div class="form-group">
                    ...
                    <input type="number" name="subtotal" id="subtotal" class="form-control"
                           value="{{ old('subtotal') }}" min="0" required>
...
<script src="{{ asset('js/admin-detail-pesanan/create.js') }}"></script>
</body>
</html>