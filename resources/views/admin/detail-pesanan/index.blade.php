...
<div class="main">
    <div class="topbar">
        <div>
            ...
            <div class="topbar-breadcrumb">Admin <i class="fa-solid fa-chevron-right" style="font-size:.55rem"></i> <span>Detail Pesanan</span></div>
        </div>
    </div>
    <div class="content">
            ...
            <div class="table-wrap">
                <table>
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td>{{ $i + 1 }}</td>
                            <td style="font-weight:600;">{{ $d->id_pesanan }}</td>
                        ...
                        @empty
                        <tr><td colspan="7"><div class="empty"><i class="fa-solid fa-list-check"></i><p>Belum ada detail pesanan</p></div></td></tr>
                        @endforelse
                    </tbody>
                </table>
            </div>
