...
.foto-current { width: 100px; height: 100px; border-radius: 10px; object-fit: cover; border: 2px solid #f0e8de; display: block; margin-bottom: 8px; }
.foto-label { font-size: 0.75rem; color: var(--text-light); margin-bottom: 6px; }
.preview-foto { margin-top: 10px; width: 100px; height: 100px; border-radius: 10px; object-fit: cover; border: 2px solid #f0e8de; display: none; }
