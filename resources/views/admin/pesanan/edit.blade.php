...
<title>Edit Pesanan – PawonLokal</title>
...
<link rel="stylesheet" href="{{ asset('css/admin-pesanan/edit.css') }}">
</head>
<body>
<div class="wrapper">
<aside class="sidebar">
...
<div class="main">
    <div class="topbar">
        <div>
            <div class="topbar-title">Edit Pesanan</div>
    ...
    <div class="content">
        <div class="page-header">
            <h1>Edit Pesanan</h1>
            <p>Ubah data pesanan #{{ $pesanan->id_pesanan }}</p>
        </div>
        <div class="form-card">
            <form action="{{ route('admin.pesanan.update', $pesanan->id_pesanan) }}" method="POST">
                ...
                <div class="form-group">
                    ...
                    <select name="id_user" class="form-control" required>
                        ...
                        @foreach($users as $u)
                            <option value="{{ $u->id_user }}" {{ old('id_user', $pesanan->id_user) == $u->id_user ? 'selected' : '' }}>
                                {{ $u->nama }} ({{ $u->email }})
                            </option>
                        @endforeach
                    </select>
                ...
                <div class="btn-group">
                    <button type="submit" class="btn-simpan">
                        <i class="fa-solid fa-floppy-disk"></i> Update Pesanan
                    </button>
...
<script src="{{ asset('js/admin-pesanan/edit.js') }}"></script>
</body>
</html>